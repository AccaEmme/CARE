...
public class LocationTest {    
	...
	@Test
	 public void VerifyGetCountry()  {
		Location l = new Location( Country.Italy, Region.Campania, Province.Avellino ,City.Avellino,"via 25 Aprile","5", "82020"); 
	...
	@Test
	 public void VerifyGetZIPcode()  {
		Location l = new Location( Country.Italy, Region.Campania, Province.Avellino ,City.Avellino,"via 25 Aprile","5", "82020"); 
		assertFalse(l.getZipCode() == null);
	}
	...
	@Test(expected = IllegalArgumentException.class)
	 public void ContryStreetNotFound() {
		  Location l = new Location(
				  Country.Italy, Region.Campania, Province.Avellino ,City.Avellino,"","5", "82020"
				  );
	  }
	...
	@Test(expected = IllegalArgumentException.class)
	 public void CountryStreetNumberNotFound() {
		  Location l = new Location(
				  Country.Italy, Region.Campania, Province.Avellino ,City.Avellino,"Via piane","", "82020"
				  );
	  }
	...
	//Verifica dell'attivazione dell'eccezione in caso in cui non venga inserita una strada
		@Test(expected = IllegalArgumentException.class)
		 public void ZIPcodeNotfound() {
			  Location l = new Location(
					  Country.Italy, Region.Campania, Province.Avellino ,City.Avellino,"Via piane","28", ""
					  );
		  }
