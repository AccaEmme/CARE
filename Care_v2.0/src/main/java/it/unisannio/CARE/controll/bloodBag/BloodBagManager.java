...
public class BloodBagManager {
	...
	public Document importBloodBag(String serial) {
		Bson filter = and(eq("serial", serial), eq("state", BloodBagState.Transfered.toString()));
	...
	public List<Document> getBloodBagsByGroup(BloodGroup group) {
		...
		Bson filter = and(eq("state", BloodBagState.Available.toString()), eq("group", group.toString()));
	...
	public boolean BloodBagRequestable(String serial_r) {
		...
		Bson filter = and(
				...
				eq("serial", serial_r), eq("state", BloodBagState.Available.toString()));
	...
	public void BloodBagMarkNotAvailable(String serial_r) {
		...
		Bson filter = and(eq("serial", serial_r), eq("state", BloodBagState.Available.toString()));
	...
	public void confirm(String serial_r) {
		Bson filter = and(eq("serial", serial_r), eq("state", BloodBagState.receiving.toString()));
