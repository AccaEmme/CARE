...
public class UserReport implements Reportable {
	...
	public UserReport(long total, long activeUsers, long inactiveUsers, long loggedLast24Hours, long blockedBySystem,
			long deleted, long administrators, long storeManagers, long officers) {
		this.total = total;
		...
		this.json = toJson(total, activeUsers, inactiveUsers, loggedLast24Hours, blockedBySystem, deleted,
				administrators, storeManagers, officers);
	}

	public String toString() {
		return "UserReport{" + "activeUsers=" + activeUsers + ", inactiveUsers=" + inactiveUsers
				+ ", loggedLast24Hours=" + loggedLast24Hours + ", blockedBySystem=" + blockedBySystem + ", deleted="
				+ deleted + ", administrators=" + administrators + ", storeManagers=" + storeManagers + ", officers="
				+ officers + '}';
	}

	public String toJson(long total, long activeUsers, long inactiveUsers, long loggedLast24Hours, long blockedBySystem,
			long deleted, long administrators, long storeManagers, long officers) {
	...
	public String getCSV(Boolean header) {
		...
		if (header)
			sb.append(
					"total,activeUsers,inactiveUsers,loggedLast24Hours,blockedBySystem,deleted,administrators,storeManagers,officers,timestamp"
							+ "\n");
	 ...
	 * 
	 * @param loggedLast24Hours Variable to enter the amount of users logged in the
	 *                          last 24H
	 */
