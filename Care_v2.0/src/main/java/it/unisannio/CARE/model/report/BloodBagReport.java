...
public class BloodBagReport implements Reportable {
	 ...
	 */
	public BloodBagReport(long total, long available, long used, long transfered, long dropped, long apos, long aneg,
			long bpos, long bneg, long ZEROpos, long ZEROneg, long ABpos, long ABneg, long usedThisWeek,
			long expiredThisWeek) {
		this.total = total;
		...
		this.json = toJson(total, available, used, transfered, dropped, apos, aneg, bpos, bneg, ZEROpos, ZEROneg, ABpos,
				ABneg, usedThisWeek, expiredThisWeek);
	}
	...
	public String toString() {
		return "BloodBagReport{" + "total=" + total + ", available=" + available + ", used=" + used + ", transfered="
				+ transfered + ", dropped=" + dropped + ", Apos=" + Apos + ", Aneg=" + Aneg + ", Bpos=" + Bpos
				+ ", Bneg=" + Bneg + ", ZEROpos=" + ZEROpos + ", ZEROneg=" + ZEROneg + ", ABpos=" + ABpos + ", ABneg="
				+ ABneg + ", timestamp=" + timestamp + ", usedThisWeek=" + usedThisWeek + ", expiredThisWeek="
				+ expiredThisWeek + '}';
	}

	public String toJson(long total, long available, long used, long transfered, long dropped, long apos, long aneg,
			long bpos, long bneg, long ZEROpos, long ZEROneg, long ABpos, long ABneg, long usedThisWeek,
			long expiredThisWeek) {
		return "BloodBagReport{" + "total=" + total + ", available=" + available + ", used=" + used + ", transfered="
				+ transfered + ", dropped=" + dropped + ", Apos=" + Apos + ", Aneg=" + Aneg + ", Bpos=" + Bpos
	...
	public String getCSV(Boolean header) {
		...
		if (header)
			sb.append(
					"total,available,transfered,dropped,Apos,Aneg,Bpos,Bneg,ZEROpos,ZEROneg,ABpos,ABneg,timestamp,usedThisWeek,expiredThisWeek"
							+ "\n");
	...
	public void print(PrintStream ps) {
		...
		ps.println("Sacche totali: " + total + ";\n" + "Sacche disponibili: " + available + ";\n" + "Sacche usate: "
				...
				+ "Apos: " + Apos + ";\n" + "Aneg: " + Aneg + ";\n" + "Bpos: " + Bpos + ";\n" + "Bneg: " + Bneg + ";\n"
				+ "ZEROpos: " + ZEROpos + ";\n" + "ZEROneg: " + ZEROneg + ";\n" + "ABpos: " + ABpos + ";\n" + "ABneg: "
				+ ABneg + ";\n" + "Timestamp: " + timestamp + ";\n" + "Sacche usate in questa settimana: "
