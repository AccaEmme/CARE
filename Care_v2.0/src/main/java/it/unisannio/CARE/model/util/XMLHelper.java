...
/**
 * is a helper class for handling XML Properties, with file initialization and
...
public class XMLHelper {
	...
	public static void initSerialXML(String serialmatrix) {
		 ...
		 * Constants.InitSettings_askNationality ); nationality = sc.nextLine(); }
		 * while(nationality.length() <0 || nationality.length()>2 );
		 * 
		 * System.out.println( Constants.InitSettings_askProvince ); prov =
		 * sc.nextLine();
		 * 
		 * System.out.println( Constants.InitSettings_askCodStr ); codstr =
		 * sc.nextLine();
		 * 
		 * System.out.println( Constants.InitSettings_askIntCod ); codint =
		 * sc.nextLine(); sc.close(); serialmatrix = nationality+"-"+prov+codstr+codint;
		 */
	...
	/**
	 ************************************************** ************************ Method that initializes the XML of the serial given
	 * a specific path (Utiel also for Junit Test)
	 * 
	...
	public static void initXMLz(int x, String filesettings) {
		...
		/*
		 * @TODO: *** if(!f.exists()) { f.createNewFile(); }
		 */
