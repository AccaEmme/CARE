...
public class Constants {
	...
	public static final String DEFAULT_NOT_AVAILABLE = "not available.";
	...
	public static final String NODE_PROPERTIES = "localsettings/node_properties.xml";
	...
	// #################################################### User Strings
	// ####################################################
	public static final String PASSWORD_SALT = "CanforaMarkUs30L";
	...
	// ####################################################
	public static final String MYSQL_LOGIN_SETTINGS_PATH = "../../login.xml"; // Credentials are not shared, file should
																				// be outside github sync path.
	...
	public static final String SQL_INSERT_NODE = "INSERT INTO " + Constants.DB_TABLE_NODE + " (" + Constants.COL_ID_NODE
			+ ", " + Constants.COL_CODSTR + ", " + Constants.COL_NODENAME + ", " + Constants.COL_COUNTRY + ", "
			+ Constants.COL_REGION + ", " + Constants.COL_PROVINCE + ", " + Constants.COL_CITY + ", "
			+ Constants.COL_STREET + ", " + Constants.COL_STREETNUMBER + ", " + Constants.COL_ZIPCODE + ", "
			+ Constants.APOSMIN + ", " + Constants.APOSMAX + ", " + Constants.ANEGMIN + ", " + Constants.ANEGMAX + ", "
			+ Constants.BPOSMIN + ", " + Constants.BPOSMAX + ", " + Constants.ABPOSMIN + ", " + Constants.ABPOSMAX
			+ ", " + Constants.ABNEGMIN + ", " + Constants.ABNEGMAX + ", " + Constants.ZEROPOSMIN + ", "
			+ Constants.ZEROPOSMAX + ", " + Constants.ZERONEGMIN + ", " + Constants.ZERONEGMAX
			+ ") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

	// #################################################### MySQL DATABASE STRINGS
	// ####################################################
	public static final String MONGODB_CREDENTIALS = "./../../uri.xml"; // Credentials are not shared, file should be
																		// outside github sync path. So we use relative
																		// parents path
	...
	public static final String SQL_CREATE_TABLE = "CREATE TABLE IF NOT EXISTS " + Constants.DB_TABLE_BLOODBAGS + "("
			+ Constants.COL_SERIAL + " varchar(33) NOT NULL," + Constants.COL_GROUP + " varchar(7) NOT NULL,"
			+ Constants.COL_CREATION + " int NOT NULL," + Constants.COL_EXPIRING + " int NOT NULL,"
			+ Constants.COL_DONATOR_CF + " char(16) NOT NULL," + Constants.COL_NOTE + " TEXT," + Constants.COL_IDSTATE
			+ " smallint NOT NULL," + " PRIMARY KEY (" + Constants.COL_SERIAL + ")" + "foreign key (" + COL_IDSTATE
			+ ") references" + "`state_table`(id_state) -- referenzia la tabella degli stati" + ")";
	public static final String SQL_INSERT_BLOODBAGS = "INSERT INTO " + Constants.DB_TABLE_BLOODBAGS + " ("
			+ Constants.COL_SERIAL + ", " + Constants.COL_GROUP + ", " + Constants.COL_CREATION + ", "
			+ Constants.COL_EXPIRING + ", " + Constants.COL_DONATOR_CF + ", " + Constants.COL_IDNODE + ", "
			+ Constants.COL_IDSTATE + ", " + Constants.COL_NOTE + ") VALUES (?,?,?,?,?,?,?,?)";

	public static final String SQL_INSERT_LOCATION = "INSERT INTO " + Constants.DB_TABLE_LOCATION + " ("
			+ Constants.COL_IDLOCATION + ", " + Constants.COL_COUNTRY + ", " + Constants.COL_REGION + ", "
			+ Constants.COL_PROVINCE + ", " + Constants.COL_CITY + ", " + Constants.COL_STREET + ", "
			+ Constants.COL_STREETNUMBER + ", " + Constants.COL_ZIPCODE + ") VALUES (?,?,?,?,?,?,?,?)";

	public static final String SQL_SELECT_BLOODBAGS = "SELECT * FROM " + Constants.DB_TABLE_BLOODBAGS + " WHERE "
			+ Constants.COL_GROUP + " = ?";
	...
	public static final String RegexSerial = "^IT-\\w{2}\\d{6}-(" + BloodGroup.delimitedValues("|")
			+ ")-\\d{8}-\\d{4}$";
	...
	public static final String RegexEmail = "^[a-zA-Z0-9_!#$%&'*+/=?`{|}~^.-]+@[a-zA-Z0-9.-]+$"; // This regex example
																									// uses all the
																									// characters
																									// permitted by RFC
																									// 5322
