...
public class Request {
	 ...
	 **************************************************************************
	 */
	public Request(String idRequester, String requestedBagSerial, Date requestDate, String note, RequestState state,
	...
	public String toString() {
		return "{" + "\"id_requester\": \"" + this.idRequester + "\"," + "\"serial\": \"" + this.requestedBagSerial
				+ "\"," + "\"date\": \"" + DATE_FORMAT.format(this.requestDate) + "\"," + "\"note\": \"" + this.note
				+ "\"," + "\"state\": \"" + this.state.toString() + "\"," + "\"priority\": \""
