...
public class BloodBagDAO {
	 ...
	 */
	public BloodBagDAO(String serial, long creationDate, String donator, long expirationDate, String group,
	...
	public String toString() {
		return "BloodBagBean{" + "serial='" + serial + '\'' + ", group='" + group + '\'' + ", donator='" + donator
				+ '\'' + ", creationDate=" + creationDate + ", expirationDate=" + expirationDate + ", state='" + state
				+ '\'' + ", notes='" + notes + '\'' + ", usedTimeStamp=" + usedTimeStamp + '}';
	}
	 ...
	 * 
	 * Serial serial = new Serial(this.serial); BloodGroup group =
	 * BloodGroup.valueOf(this.group); Date creationDate = new
	 * Date(this.creationDate); Date expirationdate = new Date(this.expirationDate);
	 * 
	 * BloodBag.BloodBagState state = BloodBag.BloodBagState.valueOf(this.state);
	 * 
	 * 
	 * return new
	 * BloodBag(serial,group,creationDate,expirationdate,this.donator,state,this.
	 * notes); }
	 */
}
